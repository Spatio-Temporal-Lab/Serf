...
class Serf64Utils {
public:
    static uint64_t findAppLong(double min, double max, double v, uint64_t lastLong, double maxDiff, long adjust_digit);

private:
    static uint64_t
    findAppLong(double minDouble, double maxDouble, uint64_t sign, double original, uint64_t lastLong, double maxDiff, long adjust_digit);
    ...
    static constexpr uint64_t bw[64] = {
            ...
            1099511627776ULL, 2199023255552ULL, 4398046511104ULL, 8796093022208ULL, 17592186044416ULL,
            35184372088832ULL, 70368744177664ULL, 140737488355328ULL,
            281474976710656ULL, 562949953421312ULL, 1125899906842624ULL, 2251799813685248ULL, 4503599627370496ULL,
